...
DATASET_PATHS = {
    'original': '/Users/asmaaaly/Minerva_Shit/Capstone/Minerva_Capstone/data/original_sequences/youtube',
    'Deepfakes': '/Volumes/MY PASSPORT/Data/manipulated_sequences/Deepfakes',
...
for dataset in DATASET_PATHS.keys():
    extract_method_videos(data_path,'Deepfakes','c40')
